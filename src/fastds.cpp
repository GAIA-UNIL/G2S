...
#include "fastDirectSamplingModule.hpp"
...
int main(int argc, char const *argv[]) {
	...
	FastDirectSamplingModule DSM(TIs, (kernels.size()==1 ? &kernels[0]:nullptr),threshold,nbCandidate,false, false, nbThreads, nbThreadsOverTi, nbThreadsLastLevel, useUniqueTI4Sampling);
