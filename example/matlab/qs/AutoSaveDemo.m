...
% QS call using G2S
[schemaResult, ~] = g2s(param{:});
simulation = schemaResult.simulation;
idx1 = schemaResult.indexmap;
...
for i=1:5
    ...
    schemaResult = g2s(param{:},'-submitOnly','-as',1,num2str(id));
    id = schemaResult.job_id;
    pause(2);
    
end

% Download data
[schemaResult, ~] = g2s('-waitAndDownload',id);  % '-kill' to interrupt a job
simulation2 = schemaResult.simulation;
idx2 = schemaResult.indexmap;
