...
while status_2 < 95:
    time.sleep(2)
    _schema_result = g2s('-statusOnly',jobid_1)
    status_1 = _schema_result.get("progress", 0)
    _schema_result = g2s('-statusOnly',jobid_2)
    status_2 = _schema_result.get("progress", 0)
...
_schema_result = g2s('-waitAndDownload',jobid_1)
sim1 = _schema_result["simulation"]
_schema_result = g2s('-waitAndDownload',jobid_2)
sim2 = _schema_result["simulation"]
