...
while status_2 < 95:
    time.sleep(2)
    status_1,*_ = g2s('-statusOnly',jobid_1, '-legacy_output')
    status_2,*_ = g2s('-statusOnly',jobid_2, '-legacy_output')
...
sim1,*_ = g2s('-waitAndDownload',jobid_1, '-legacy_output')
sim2,*_ = g2s('-waitAndDownload',jobid_2, '-legacy_output')
